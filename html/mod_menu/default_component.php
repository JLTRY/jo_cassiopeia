...
switch ($item->browserNav)
{
	default:
	case 0:
?><a <?php echo $class ?>href="<?php echo $item->flink; ?>" <?php echo $title; ?> <?php if(property_exists($item,'data')) {echo $item->data;} ?>><?php echo $linktype; ?></a><?php
		break;
	case 1:
		// _blank
?><a <?php echo $class; ?>href="<?php echo $item->flink; ?>" target="_blank" <?php echo $title; ?> <?php  if(property_exists($item,'data'))  {echo $item->data;} ?>><?php echo $linktype; ?></a><?php
		break;
	case 2:
